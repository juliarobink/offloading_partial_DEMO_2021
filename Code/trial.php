 ...
 */
    ...
    if (!isset($_SESSION['Timestamp'])) {
        ...
        // $numSavesTrialOne = 7;
        // $_SESSION['numSavesTrialOne'] = $numSavesTrialOne;

        // $numSavesTrialTwo = 7;
        // $_SESSION['numSavesTrialTwo'] = $numSavesTrialTwo;

        // $numSavesTrialThree = 7;
        // $_SESSION['numSavesTrialThree'] = $numSavesTrialThree;
